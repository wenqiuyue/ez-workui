<template>
  <div class="content-box">
    ...
    <div class="title-box">
      <!-- 左 -->
      <div class="tit-left" v-text="indexData.name" v-if="showLabel"></div>
      <div class="tit-left" v-else>标签详情</div>
      <!-- 右 -->
      <div class="tit-right">
        <span
          v-if="indexData.type === 'Add'"
          v-show="!submiting"
          @click="topSubmit"
          >提交
        </span>
        ...
        <i
          class="el-icon-close"
          title="关闭窗口"
          @click="$modal.hide(indexData.xModalName)"
        ></i>
      </div>
    </div>
