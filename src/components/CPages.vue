    ...
    <el-row>
        ...
        <el-col :span="24" class="hidden-sm-and-down">
            <el-pagination background
                ...
                :page-sizes="[10, 30, 50, 100]" :total="childData.totalNum"
        ...
        <el-col :span="24" class="hidden-md-and-up">
            <el-button type="primary" size="small" :disabled="childData.pageIndex <= 1"
                @click="prePageClick">
                上一页
            </el-button>
            <el-select v-model="childData.pageIndex" 
                placeholder="跳页" @change="selectPageClick"
                style="width:80px;" size="small">
                <el-option v-for="index in Math.ceil(childData.totalNum/childData.pageSize)" 
                    :key="index" :value="index" :label="'第' + index + '页'">
                </el-option>
            </el-select>
            <el-button type="primary" size="small" 
                :disabled="childData.pageIndex >= Math.ceil(childData.totalNum/childData.pageSize)"
                @click="nextPageClick">
                下一页
            </el-button>
