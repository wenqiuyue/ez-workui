<template>
  <div class="file_operation">
    <Header
      title="文件操作监控"
      titleEnglish="File Operation Monitoring"
      class="baseHeader"
    >
    </Header>
    <div class="file_operation_content">
        ...
        <div class="sel_inline">
          ...
          <div class="sel">
            <div class="team">
              ...
              >
                <el-option
                  v-for="item in $D.LIST('file_operation')"
                  :key="item.value"
                  :label="item.name"
                  :value="item.value"
                >
      ...
      <div class="file_operation_list" v-loading="loading">
        <div class="file_operation_table" v-if="tableData && tableData.length">
          <el-table
            :data="tableData"
            border
          ...
          >
            <el-table-column label="时间" show-overflow-tooltip align="center">
              <template slot-scope="scope"> 2021-09-16 10:21:11 </template>
            </el-table-column>
            <el-table-column
              label="操作类型"
            ...
            <el-table-column
              ...
              align="center"
            >
              <template slot-scope="scope"> Administrator </template>
            </el-table-column>
            <el-table-column
              label="使用者"
              show-overflow-tooltip
              align="center"
            >
              <template slot-scope="scope"> 王小丫 </template>
            </el-table-column>
          </el-table>
          <el-pagination
