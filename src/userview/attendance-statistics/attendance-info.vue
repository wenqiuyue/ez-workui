              ...
              >
                ...
                >
                  ...
                  <el-col :sm="24" :md="18" class="hidden-sm-and-down">
                    ...
                    <p v-else class="cell-title-right">审核中</p>
                  </el-col>
                </el-row>
                <el-row
...
export default {
  ...
  components: {
    ...
    // AttendanceCalendar: () => import("./attendanceCalendar"),
    // ReimbursementModal: () => import("./reimbursementModal"),
    // BriefingModal: () => import("./briefingModal"),
    // MyAssessmentModal: () => import("../assessment/myAssessmentModal"),
    // Report: () => import("../report/reportDetail"),
  ...
  methods: {
    ...
    // 平板单击cell就触发
    attendanceCellMobileClick(e, obj) {
      if (document.body.clientWidth <= 991) {
        this.moblieOlData = obj; // 移动端点击先展示,要打开弹层还需要继续点新按钮,这之前先把数据存好
        // console.log(obj);
      }
    },
    // 拆解父组件传递的参数
